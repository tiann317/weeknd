...
def run():
    with SessionLocal() as db:
        ...
        garmisch = Station(
            ...
            lon=11.095,
            operator="DB Regio",
            is_private_railway=False,
            dticket_valid=True,
        )
        zugspitze = Station(
            name="Zugspitzplatt (BZB)",
            lat=47.418,
            lon=10.980,
            operator="Bayerische Zugspitzbahn",
            is_private_railway=True,
            dticket_valid=False,
        )
        kochel = Station(
            name="Kochel",
        ...
        db.add_all(
            [
                ...
                Hike(
                    title="Herrsching → Kloster Andechs",
                    region="Ammersee",
                    sport=SportType.hike,
                    distance_km=6.5,
                    duration_min=120,
                ...
                Hike(
                    title="Zugspitze Gipfel via Bayerische Zugspitzbahn",
                    region="Garmisch",
                    sport=SportType.hike,
                    distance_km=4.0,
                    duration_min=90,
